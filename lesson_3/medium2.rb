# 1) Predict how the values and object ids will change throughout the flow of
#    the code below:
=begin
def fun_with_ids
  a_outer = 42            # => 1
...
def an_illustrative_method(a_outer, b_outer, c_outer, d_outer, a_outer_id, b_outer_id, c_outer_id, d_outer_id)
  ...
  a_outer = 22                # 4  # these are not the same variables as those from the peer scope 
...
# Focus on writing code that makes the result easier to predict and easier
