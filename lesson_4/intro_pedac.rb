...
# Typical student algorithm. Not detailed enough...
...
# If we implement solution at this point, it will lead to hack and slash coding

# Better approach:
# 1)Write Algorithm
# 2) Write Code
# 3) Return to algorithm/refine understanding
...
# Considering the complexity of the above informal pseudocode, might
# be a good idea to implement formal pseudo code - an intermediate step
# between informl pseudo code and programming language. can be helpful
