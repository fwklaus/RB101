def sum_even_number_row(row_number)
  ...
  rows.last.sum  # TODO; sum the final rows and return the sum
end
...
# 4. Repeat steps 2 & 3 until the array has reached the corrrect length
...
#                   -circular process - switch back and forth when necessary
#                       -implementation/abstract problem solving
