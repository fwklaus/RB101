...
# available to the String s; this includes not only those methods defined
# in the String class, but also methods that are inherited from Object
# (which inherits other methods from the BasicObject class and the Kernel
